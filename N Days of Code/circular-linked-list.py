# circular linked lists do not have ends While traversing the circular linked lists we should be careful otherwise we will be traversing the list infinitely. In circular linked lists each node has a successor.
# Note that unlike singly linked lists, there is no node with NULL pointer in a circularly linked list. In some situations, circular linked lists are useful. 
# applications- Circular linked lists are used in managing the computing resources of a computer.
